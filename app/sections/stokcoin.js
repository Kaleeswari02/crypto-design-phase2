          ...
          <div className="relative flex items-center justify-center backgroundgreen">
            <div className="relative w-96 h-96">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-64 h-64 bg-green-500/20 rounded-full blur-3xl"></div>
              </div>
              {/* Central STOK Coin */}
              ...
              {/* Orbiting Coins */}
              <div
                className={`absolute spinner-layer inset-0 ${mounted ? 'animate-spin-trigger' : ''}`}
              >
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        zIndex:
                          -12 /* Ensure they are behind the central coin */,
                      }}
                    >
