...
export const CardAnimation = () => {
  ...
  card_tl
    // Intro
    .fromTo(".card_component",
      { opacity: 0, rotateY: 60, rotateX: 45, transformPerspective: 2300, transformOrigin: "center top" },
...
.fromTo(
  ...
  { opacity: 1, scale: 1.2, color: "#fff" } // end white
    ...
    // Border animation
    .fromTo(".card_border", { border: "2px solid transparent", borderRadius:'30px' }, { border: "2px solid white" ,borderRadius:'30px' }, "<")
