...
<div className="border-t border-gray-700 mb-6 w-[1200px] mx-auto"></div>
  <div className="mt-6 text-center text-white text-[16px] font-kraeftig mb-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto w-full text-sm">
        {/* Left */}
        <Link href="/terms" className="mb-4 md:mb-0 hover:underline font-kraeftig text-[16px]">
          Terms & Conditions
        </Link>

        {/* Center Social Icons */}
        <div className="flex gap-6 mb-4 md:mb-0">
          <a href="#" className="bg-black w-12 h-12 flex items-center justify-center rounded-full hover:scale-110 transition">
            <FaFacebook size={18} />
          </a>
          <a href="#" className="bg-black w-12 h-12 flex items-center justify-center rounded-full hover:scale-110 transition">
            <FaXTwitter size={18} />
        ...
        {/* Right */}
        <Link href="/privacy" className="hover:underline font-kraeftig text-[16px]">
          Security & Privacy
        </Link>
      </div>
